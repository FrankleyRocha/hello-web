...
a persistence unit "hello-webPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "hello-web/pom.xml":
...
artifact ("hello-web.war") is already built. You can build
